public class TesyDeviceCommandsClass
{
    ...
    private Dictionary<string, MyDevicesContent> myDevicesContent;
    ...
    public TesyDeviceCommandsClass(TesyHttpClass tesyHttpClass, Cn05uvConvector convector, TesyDeviceSettingsClass tesyDeviceSettings)
    {
        this.tesyHttpClass = tesyHttpClass;
        this.convector = convector;
        this.tesyDeviceSettings = tesyDeviceSettings;
        myDevicesContent = tesyHttpClass.MyDevicesContentResponse;
    ...
    public void TurnLockDeviceOnOff()
    {
        myDevicesContent = tesyHttpClass.MyDevicesContentResponse;
    ...
    public void TurnOpenedWindowOnOff()
    {
        myDevicesContent = tesyHttpClass.MyDevicesContentResponse;
    ...
    public void TurnAntiFrostOnOff()
    {
        myDevicesContent = tesyHttpClass.MyDevicesContentResponse;
    ...
    public void TurnAdaptiveStartOnOff()
    {
        myDevicesContent = tesyHttpClass.MyDevicesContentResponse;
    ...
    public void SetDeviceName()
    {
        ...
        tesyHttpClass.PostTesyUpdateDeviceSettings(queryParams);
    }
